package View;
public class TaoVaiTroView extends SubViewer {
    public TaoVaiTroView(GiaoDienChinhView parentView) {
        super(parentView);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_quyen = new javax.swing.JTable();
        ...
        jLabel1.setText("Tạo vai trò");

        jTable_quyen.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jScrollPane1.setViewportView(jTable_quyen);
    ...
    private javax.swing.JTable jTable_quyen;
